...
// log to `latex/corpus/<doc>/logs/texlive.log`, and records the page count
// in `latex/corpus/pages.json`, which the headless check then holds each
// distribution to.
//
...
const EXAMPLES = [
  ...
  // It exists to measure a package set: see latex/corpus/packages/main.tex.
