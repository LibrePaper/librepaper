...
- `KOMODOC_VERSION` selects a release.
- `KOMODOC_BIN_DIR` selects an installation directory.
- Windows: use the matching executable from the
  [release page](https://github.com/vincentarelbundock/komodoc/releases).

Run `komodoc agent --help` again afterwards. If the installed release still
...
`komodoc login --help` describes that for the deployment in question; sign-in
