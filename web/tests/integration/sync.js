...
// The other anchor -- a whole selection taken to a place in the source -- was
// measured here too, against the same corpus. It is not measured here any
// more because it is not done here any more: a comment's source range is
// worked out by the server, in `room::locate`, from the words a browser saw.
// What that does is covered by that module's own tests; what is left in this
// file is caret syncing, which is still both sides' business.
...
//
// Built here rather than added to docs/examples/: it exists to exercise the lock
