...
//! browser and the local Komodoc service, and between the service and the
//! native runner. See `docs/specs/wasmtex-interfaces.md`, section 5.
//!
...
/// The default loopback port. Configurable with `komodoc local start --port`.
pub const DEFAULT_PORT: u16 = 8763;

/// The base path every route hangs under.
pub const BASE_PATH: &str = "/komodoc/local/v1";
