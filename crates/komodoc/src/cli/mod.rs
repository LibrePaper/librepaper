//! The command line: what `komodoc` accepts, and `main`, which runs it.
...
/// `komodoc local <command>`. See `crate::local::cli`.
...
/// The arguments `komodoc local` hands to `crate::local::run`.
#[derive(Clone, Debug)]
