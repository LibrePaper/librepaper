-- SUPERSEDED. This DDL describes a SQLite catalog v2 that was never shipped.
-- The storage that ships is PostgreSQL catalog v3; the only normative DDL is
-- crates/librepaper/migrations/postgres/. See docs/specs/catalog-v3-postgres.md.
-- Kept for the constraint reasoning it records, not as an implementation target.
