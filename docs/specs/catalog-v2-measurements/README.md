...
These measurements cover the SQL matrix in specification section 24. They do **not** establish completion of the migration or acceptance of its runtime protocols. The physical journal comparison and randomized root/physical-inventory audit are separate, unfinished gates.
