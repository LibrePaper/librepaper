...
> [specs/catalog-v3-postgres.md](specs/catalog-v3-postgres.md), which starts from the
...
> Its file references (`migrations/0001_catalog.sql`, `src/storage/catalog/`)
> point at a SQLite baseline that no longer exists in the tree.
