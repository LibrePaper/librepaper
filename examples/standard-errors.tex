...
This note is written in \LaTeX, and Komodoc stored the source as it was published: nothing compiled it on the way. The compiler runs in the browser instead, so the PDF beside the source is the document you are reading.
